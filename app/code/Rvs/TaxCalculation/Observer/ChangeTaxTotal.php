    ...
    public function execute(Observer $observer)
    {
       ...
       // $subtotal = $total['subtotal'];
		...
		foreach( $cartData as $item ){
			if($item->getProduct()->getData('merchant_email') != ''){
			$merchant_email[] = $item->getProduct()->getData('merchant_email');
			}
		}
        foreach( $cartData as $item ){
			...
			$merchantEmailc = "";
			if($item->getProduct()->getData('merchant_email') != ''){
			 $currentmerchant_email = $item->getProduct()->getData('merchant_email');
