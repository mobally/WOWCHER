...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function needToSave($object)
    {
        ...
        $notForSaveClasses = [
            ...
            \Magento\Bundle\Model\Link::class,
        ...
        if ($this->isObjectClassInArray($object, $notForSaveClasses)) {
            return false;
        }
    ...
    public function needOldData($object)
    {
        ...
        if ($this->isObjectClassInArray($object, $notNeededObjects)) {
            return false;
        }

        if ($this->isObjectClassInArray($object, $neededObjects)
    ...
    public function isObjectClassInArray($object, array $objectClasses)
    {
