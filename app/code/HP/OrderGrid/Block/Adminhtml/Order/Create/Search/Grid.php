 ...
 */
namespace HP\OrderGrid\Block\Adminhtml\Order\Create\Search;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            'header' => __('Image'),
            'index' => 'image',
            'renderer'  => '\HP\OrderGrid\Block\Adminhtml\Product\Grid\Renderer\Image',
            'filter' => false,
            ]
        );
